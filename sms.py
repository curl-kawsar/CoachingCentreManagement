...
def toplevel_data(title,button_text,command):
    ...
    idLabel = Label(screen, text='PID', font=('times new roman', 20, 'bold'))
    ...
    emailLabel = Label(screen, text='Parents No', font=('times new roman', 20, 'bold'))
    emailLabel.grid(row=3, column=0, padx=30, pady=15, sticky=W)
    emailEntry = Entry(screen, font=('roman', 15, 'bold'), width=24)
    emailEntry.grid(row=3, column=1, pady=15, padx=10)

    addressLabel = Label(screen, text='College', font=('times new roman', 20, 'bold'))
    addressLabel.grid(row=4, column=0, padx=30, pady=15, sticky=W)
    addressEntry = Entry(screen, font=('roman', 15, 'bold'), width=24)
    addressEntry.grid(row=4, column=1, pady=15, padx=10)

    genderLabel = Label(screen, text='Group', font=('times new roman', 20, 'bold'))
    genderLabel.grid(row=5, column=0, padx=30, pady=15, sticky=W)
    genderEntry = Entry(screen, font=('roman', 15, 'bold'), width=24)
    genderEntry.grid(row=5, column=1, pady=15, padx=10)

    dobLabel = Label(screen, text='Payment/Month', font=('times new roman', 20, 'bold'))
...
def connect_database():
    def connect():
        global mycursor,con
        try:
            con=pymysql.connect(host='localhost',user='root',password='kkkkssss')
            mycursor=con.cursor()
        except:
...
studentTable.heading('Id',text='PID')
studentTable.heading('Name',text='Name')
studentTable.heading('Mobile',text='Mobile No')
studentTable.heading('Email',text='Parents No')
studentTable.heading('Address',text='College')
studentTable.heading('Gender',text='Group')
studentTable.heading('D.O.B',text='Payment/Month')
studentTable.heading('Added Date',text='Payment Date')
